...
resultat_ex2 = []
for i in range(donnees["range2_start"],
               donnees["range2_stop"]):
...
resultat_ex3 = []
for i in range(donnees["range3_start"],
               donnees["range3_stop"],
               donnees["range3_step"]):
...
resultat_ex4 = []
for i in range(donnees["range4_start"], 
               donnees["range4_stop"], 
               donnees["range4_step"]):
...
resultat_ex7 = []
for i in range(donnees["multiple"],
               donnees["multiple_fin"] + 1, 
               donnees["multiple"]):
...
for i in range(len(donnees["chaine3"])):
    if donnees["chaine3"][i] == donnees["lettre2"] and not trouve:
        resultat_ex9 = i
        trouve = True
...
for i in range(len(donnees["mot1"]) - 1, -1, -1):
    resultat_ex10 = resultat_ex10 + donnees["mot1"][i]
