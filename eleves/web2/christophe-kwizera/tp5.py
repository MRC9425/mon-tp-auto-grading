...
for caractere in "bonjour":
    ...
    majuscule = chr(code_ascii - 32)
    resultat_ex11 += majuscule
...
for caractere in "algorithmique":
    if caractere in voyelles:
        resultat_ex12 += caractere
