...
resultat_ex11 = ""
for lettre in texte:
    resultat_ex11 += chr(ord(lettre) - 32)
...
chaine_voyelles = "algorithmique"
voyelles = "aeiouy"
resultat_ex12 = ""
for lettre in chaine_voyelles:
    if lettre in voyelles:
        resultat_ex12 += lettre
...
resultat_ex13 = []
for i in range(1, 11):
    resultat_ex13.append(f"7 x {i} = {7 * i}")
